...
export const select = tv({
  slots: {
    trigger:
      "flex h-10 w-full cursor-pointer items-center justify-between rounded-md border border-stroke-subtle bg-layer px-2 text-style-label1 placeholder:text-foreground-emphasized disabled:cursor-not-allowed disabled:opacity-50",
    viewport:
    ...
    label: "py-1.5 pl-8 pr-2 text-style-label1",
