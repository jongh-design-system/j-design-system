...
<PropsTable>
  <PropRow
    name="defaultValue"
    type="number[]"
    description="초기 선택된 값입니다 (비제어 모드)."
  />
  <PropRow
    name="value"
    type="number[]"
    description="현재 선택된 값입니다 (제어 모드)."
  />
  <PropRow
    name="onValueChange"
    type="(value: number[]) => void"
    description="값이 변경될 때 호출되는 함수입니다 (제어 모드)."
  />
  <PropRow
    name="min"
    type="number"
  ...
  <PropRow
    name="step"
    type="number"
    description="값이 증가하거나 감소하는 단위입니다."
    defaultValue="1"
  />
  <PropRow
    name="disabled"
    type="boolean"
    description="슬라이더의 비활성화 여부를 지정합니다."
    defaultValue="false"
  />
</PropsTable>
